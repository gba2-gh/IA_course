...
%%Gibran Zazueta Cruz
%%%Backpropagation  Funcion de -6 a 6
format long
clear
clc
close all

addpath('C:\Users\gba2\Desktop\MCC 2022-I\IA\funciones')
p = -6:0.1:6;
...
%diff()
%Pesos 1ra capa, 2 neuronas de 1 entrada
w1 =[-0.27; -0.41; 0.1];
b1 = [-.48 ;-0.13; 0.1];

%Peso segunda capa, 1 neurona de 2 entradas
w2 = [0.09 -0.17 0.1];
b2 = 0.48;
